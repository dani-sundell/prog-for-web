  ...
  <div class="deck-detail__container">
    <div class="deck-detail__body">
      ...
      <div class="pill__container">
        ...
        <div class="pill tags"
        v-bind:class="{gift: item.methodOfAcquisition.includes('Gift') === true, purchased: item.methodOfAcquisition.includes('Purchased') === true, inherited: item.methodOfAcquisition.includes('Inherited') === true}">
        {{item.methodOfAcquisition}}</div>
        <div class="pill tags"
        v-bind:class="{
